...
const PAGE_SCHEMA = {
    home: [
        { key: 'hero-title', label: 'Заголовок Hero', type: 'text' },
        { key: 'hero-subtitle', label: 'Підзаголовок Hero', type: 'textarea' },
        { key: 'hero-video', label: 'Відео Hero', type: 'video' },
        { key: 'about-p1', label: 'Опис клініки (параграф 1)', type: 'textarea' },
        { key: 'about-p2', label: 'Опис клініки (параграф 2)', type: 'textarea' },
        { key: 'interior-video', label: 'Відео інтер\'єру', type: 'video' },
    ],
    about: [
        { key: 'about-hero-img', label: 'Фото Hero', type: 'image' },
        { key: 'about-desc', label: 'Опис "Про нас"', type: 'textarea' },
        { key: 'about-mission', label: 'Місія клініки', type: 'textarea' },
    ],
    services: [
        { key: 'services-title', label: 'Заголовок сторінки', type: 'text' },
        { key: 'services-subtitle', label: 'Підзаголовок', type: 'textarea' },
    ],
    cases: [
        { key: 'cases-title', label: 'Заголовок сторінки', type: 'text' },
    ],
    contact: [
        { key: 'contact-title', label: 'Заголовок', type: 'text' },
        { key: 'contact-address', label: 'Адреса', type: 'text' },
        { key: 'contact-phone', label: 'Телефон', type: 'text' },
        { key: 'contact-hours', label: 'Графік роботи', type: 'text' },
    ]
};
