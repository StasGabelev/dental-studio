...
const PAGE_SCHEMA = {
    ...
    "about": [
        ...
        { "key": "price-children-caries-milk-val", "label": "💰 Ціна: Карієс молочного зуба", "type": "text" },
        { "key": "price-children-caries-perm", "label": "Назва: Карієс постійного зуба (дитина)", "type": "text" },
