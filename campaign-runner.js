...
const PROCEDURE_FLOWS = [
    {
        keywords: ['видалення зуба', 'видалення', 'удалення', 'атипове видалення'],
        followups: [
            { delay_hours: 2,  message: '🦷 Дякуємо за довіру до Dental Studio!\n\nПісля видалення зуба важливо дотримуватись кількох простих рекомендацій:\n\n• Не вживайте їжу та напої протягом 2 годин\n• Уникайте гарячого, гострого та твердого\n• При дискомфорті — прийміть призначений знеболювальний засіб\n• Не торкайтеся лунки язиком\n\nМи завжди поруч 💙 Пишіть, якщо виникнуть питання!' },
            { delay_hours: 20, message: '🌅 Доброго ранку!\n\nЯк ваше самопочуття після вчорашньої процедури? Сподіваємось, відновлення проходить комфортно.\n\nЯкщо турбує набряк або больові відчуття — не зволікайте, зателефонуйте нам. Ваш стан для нас — найважливіше! 💙' },
            { delay_hours: 72, message: '💙 Три дні після видалення — лунка активно загоюється.\n\nЯкщо відчуваєте будь-який дискомфорт або є запитання — будемо раді прийняти вас на безкоштовний контрольний огляд.\n\nТурбота про вашу посмішку — наша місія! 🦷✨' }
        ]
    },
    {
        keywords: ['імплантація', 'імплант', 'імплантат'],
        followups: [
            { delay_hours: 3,  message: '🦷 Дякуємо за вибір Dental Studio!\n\nПісля імплантації дотримуйтесь рекомендацій лікаря:\n\n• Уникайте фізичних навантажень протягом 24 годин\n• Прикладайте холод по 15 хвилин для зменшення набряку\n• Не куріть — це уповільнює загоєння\n• Приймайте призначені ліки за схемою\n\nМи поруч — пишіть, якщо є питання! 💙' },
            { delay_hours: 24, message: '🌅 Добрий день!\n\nЯк ваше самопочуття після імплантації? Невеликий набряк та дискомфорт у перші дні — це нормальна реакція організму.\n\nЯкщо відчуваєте сильний біль або підвищену температуру — зателефонуйте нам одразу. Ви не самі! 💙' },
            { delay_hours: 168, message: '🌟 Тиждень після імплантації!\n\nСподіваємось, відновлення проходить добре та ви вже відчуваєте себе значно краще.\n\nЧерез 3–6 місяців ми запросимо вас на контрольний огляд і встановлення постійної коронки. До зустрічі!\n\nДякуємо за довіру до Dental Studio 🦷💙' }
        ]
    },
    {
        keywords: ['відбілювання'],
        followups: [
            { delay_hours: 4, message: '✨ Дякуємо за візит!\n\nПісля відбілювання зубів протягом 48 годин дотримуйтесь "білої дієти":\n\n• Уникайте кави, чаю, червоного вина\n• Не вживайте яскраво забарвлених продуктів\n• Не куріть\n\nЦе допоможе зберегти ефект якомога довше! 🦷💫' },
            { delay_hours: 72, message: '😊 Як ваша посмішка після відбілювання?\n\nСподіваємось, результат вас порадував! Якщо є питання — ми завжди на зв\'язку.\n\nДбайте про свою усмішку — вона ваш найкращий аксесуар! ✨💙' }
        ]
    }
];
