const translations = {
    UA: {
        ...
        "svc-consult-therapy-desc": "Лікар проводить повну діагностику стану ротової порожнини, сканує зуби, оглядає зуби під мікроскопом та складає план лікування із кошторисом по кожному етапу роботи.",
        "svc-consult-surgery-title": "Консультація",
        "svc-consult-surgery-desc": "Лікар проводить повну діагностику стану ротової порожнини, сканує зуби, оглядає зуби під мікроскопом та складає план лікування із кошторисом по кожному етапу роботи.",
        "svc-consult-ortho-title": "Консультація",
        "svc-consult-ortho-desc": "Лікар проводить повну діагностику стану ротової порожнини, сканує зуби, оглядає зуби під мікроскопом та складає план лікування із кошторисом по кожному етапу роботи.",
        "svc-consult-children-title": "Консультація",
        "svc-consult-children-desc": "Лікар проводить повну діагностику стану ротової порожнини, сканує зуби, оглядає зуби під мікроскопом та складає план лікування із кошторисом по кожному етапу роботи.",
    ...
    EN: {
        ...
        "svc-consult-therapy-title": "Consultation",
        "svc-consult-therapy-desc": "The doctor conducts a complete diagnosis of the oral cavity, scans the teeth, examines them under a microscope, and creates a treatment plan with an estimate for each stage of work.",
        "svc-consult-surgery-title": "Consultation",
        "svc-consult-surgery-desc": "The doctor conducts a complete diagnosis of the oral cavity, scans the teeth, examines them under a microscope, and creates a treatment plan with an estimate for each stage of work.",
        "svc-consult-ortho-title": "Consultation",
        "svc-consult-ortho-desc": "The doctor conducts a complete diagnosis of the oral cavity, scans the teeth, examines them under a microscope, and creates a treatment plan with an estimate for each stage of work.",
        "svc-consult-children-title": "Consultation",
        "svc-consult-children-desc": "The doctor conducts a complete diagnosis of the oral cavity, scans the teeth, examines them under a microscope, and creates a treatment plan with an estimate for each stage of work.",
